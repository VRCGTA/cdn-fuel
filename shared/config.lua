...
Config.CostMultiplier = 30 -- Amount to multiply 1 by. This indicates fuel price. (Default: $3.0/l or 3.0)
...
Config.JerryCanPrice = 5000 -- The price of a jerry can, not including tax.
...
Config.MinimumFuelPrice = 0 -- This is the minimum value you want to let players set their fuel prices to.
...
Config.GasStations = { -- Configuration options for various gas station related things, including peds, coords and labels.
    ...
    [29] = {
        ...
        cost = 5000000, -- This is the cost of the gas station for someone purchasing it, not including tax.

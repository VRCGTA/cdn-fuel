local Translations = {
  ...
  cancelled = "キャンセルした",
  not_enough_money = "十分な資金を持っていません！",
  not_enough_money_in_bank = "銀行に十分な預金がありません！",
  not_enough_money_in_cash = "ポケットに十分なお金がありません！",
  more_than_zero = "0L以上で指定する必要があります！",
  emergency_shutoff_active = "現在ポンプは緊急停止システムにより停止しています",
  nozzle_cannot_reach = "ノズルはここまで届きません！",
  station_no_fuel = "このスタンドは燃料切れしています！",
  station_not_enough_fuel = "スタンドには指定した分だけの燃料が残っていません！",
  show_input_key_special = "車両の近くで [G] を押して給油",
  tank_cannot_fit = "タンクが適合していません！",
  tank_already_full = "この車両は既に満タンです！",
  need_electric_charger = "充電器が必要です！",
  cannot_refuel_inside = "車内から給油は出来ません！",
  ...
  menu_manage_sell_station_footer = "ガソリンスタンドを売却: $",
  ...
  input_alter_fuel_price_header_2 = " / リッター",
